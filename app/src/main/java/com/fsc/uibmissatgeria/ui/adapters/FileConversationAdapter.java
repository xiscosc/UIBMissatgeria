...
public class FileConversationAdapter extends RecyclerView.Adapter<FileConversationAdapter.PeerViewHolder>
    ...
    public static class PeerViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindSubject(FileMessageConversation f, Context c, boolean editable) {
            if (f.haveFile() ) {
                if (f.isImage()){
    ...
    public FileConversationAdapter(List<FileMessageConversation> files, Context c, boolean editable) {
        this.files = files;
        this.c = c;
    ...
    public void onBindViewHolder(PeerViewHolder viewHolder, int pos) {
        final FileConversationAdapter self = this;
        FileMessageConversation item = files.get(pos);
        ...
        if (editable) {
            viewHolder.fileRemove.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    FileMessageConversation path = files.get(post);
                    files.remove(post);
